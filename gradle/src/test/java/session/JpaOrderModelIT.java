...
//    }
    ...
    public void persistOrderShouldModifyDataStore() {
        //arrange
        JpaOrderModel orderModel = new JpaOrderModel();
        JpaFilmDAO filmDAO = new JpaFilmDAO();
...
//        int id = orderModel.persistOrder();
        ...
        Film film1 = filmDAO.selectById(1L);
        Film film2 = filmDAO.selectById(2L);
        Film film3 = filmDAO.selectById(3L);
